...
<body>
  ...
  <div id="preloader">
    ...
    <?php
      require_once 'feedback-card.php'; // Подключение к файлу с PHP кодом
      $car = getFeedbackFromDatabase(); // Получение данных из базы данных
      // Вывод карточек
      if ($car){
          foreach ($car as $card) {
              echo "<div class='card' id='" . $card["id"] . "' data-title='" . $card["car_brand"] . "'>";
                echo "<div class='img_hp'>";
                  echo "<img class='photo_front' src=../auto/pic/". $card["photo_front"] . ">";
                echo "</div>";
                echo "<div class='tag'>";
                  ...
                  echo "</div>";
                  echo "<div class='p_cont'>";
                      echo "<p>" . $card["feedback"] . "</p>";
                  echo "</div>";
                  echo "</div>";
              echo "</div>";
          }
